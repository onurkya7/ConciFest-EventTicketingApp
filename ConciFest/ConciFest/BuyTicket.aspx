<%@ Page Title="" Language="C#" MasterPageFile="~/MemberPage.Master" AutoEventWireup="true" CodeBehind="BuyTicket.aspx.cs" Inherits="ConciFes.BuyTicket1" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-10 mx-auto">
                            <div class="custom-form ticket-form mb-5 mb-lg-0">
                                <h2 class="text-center mb-4">Bilet alma</h2>
                                ...
                                <div class="ticket-form-body">
                                    ...
                                    <div class="col-lg-4 col-md-10 col-8 mx-auto">
                                         <asp:Button ID="Button1" CssClass="form-control" runat="server" Text="Bilet Al" style="background-color: #ee5007; color: white; margin-top: 10px;" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
